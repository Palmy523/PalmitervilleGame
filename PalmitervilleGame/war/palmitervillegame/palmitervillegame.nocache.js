...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "palmitervillegame" because\n';
  ...
  $wnd.__gwt_activeModules['palmitervillegame'] = {
    'moduleName' : 'palmitervillegame',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/palmitervillegame.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['palmitervillegame'].superdevmode = true;

  var expectedSuffix = '/palmitervillegame.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + palmitervillegame + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:palmitervillegame';
  var devModeSessionKey = '__gwtDevModeSession:palmitervillegame';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/palmitervillegame/palmitervillegame.nocache.js';
  ...
  $wnd.__gwt_activeModules['palmitervillegame'].canRedirect = true;
  $wnd.__gwt_activeModules['palmitervillegame'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING palmitervillegame';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/palmitervillegame?user.agent=' + ua + '&_callback=' + callback;
